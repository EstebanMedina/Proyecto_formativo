...
if (OK) {
  $.ajax({
    url:"concepto?accion=Eliminar&idConcepto="+id,
  ...
  icon: "success",
          ...
          if(OK){
              location.href="concepto?accion=Eliminar&idConcepto="+id
          }
        });
} else {
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="nomina?accion=listar"><img src="assets/img/vsg/clipboard.svg" alt="">| Consultar una novedades</a></li>
              </ul>
            </div>
          </li>
          ...
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body"><br><br><br>
                <h4 class="card-title">Tabla de Nómina</h4>
                </p>
                <div class="table-responsive">
                  <table class="table table-bordered datatable" id="datatable">
                    ...
                    <td align="center">
                      <a onclick="Eliminar([[${Concepto.getIdConcepto()}]])">
                        <em class="fa fa-trash"><button class="btn btn-outline-danger btn-icon-text" type="button">
                             Eliminar</button></em></a>
                      </td>
                      <td align="center">
                      <a href="nomina?accion=abrir&idNomina=${Concepto.getIdConcepto()}" class="btn btn-default"><em class="fa fa-trash"><button type="button" class="btn btn-outline-danger btn-icon-text">Horas Extras</button></em></a>
                      <a href="nomina?accion=entrar&idNomina=${Concepto.getIdConcepto()}" class="btn btn-default"><em class="fa fa-trash"><button type="button" class="btn btn-outline-danger btn-icon-text">Vacaciones</button></em></a>
                      </td>
                    </c:forEach>  
                    </tbody>
                  </table>
