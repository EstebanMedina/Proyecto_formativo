                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-8">
                        <div class="d-flex align-items-center align-self-start">
                          <h4 class="mb-0 asd"><a href="nomina?accion=listar">Nómina</a></h4>
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="icon icon-box-success">
                      ...
                      <h6 class="text-muted font-weight-normal">Aquí podras consultar todos las nóminas</h6>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-8">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0 asd"><a href="concepto?accion=Consultar">Concepto</a></h3>
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="icon icon-box-success">
                    ...
                    <h6 class="text-muted font-weight-normal">Aquí podras consultar todos los conceptos</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
