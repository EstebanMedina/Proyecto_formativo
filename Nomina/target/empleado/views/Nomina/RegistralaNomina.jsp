            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body"><br><br><br>
                        <h4 class="card-title">Agregar una novedad Vacaciones</h4>
                        <p class="card-description">Registra una novedad</p>
                        <c:forEach var="nomina" items="${listars}">  
                        <form class="forms-sample needs-validation" action="nomina" method="post" novalidate>
            
                          <div class="form-group">
                                <label for="exampleInputName1 validationCustom01">Fecha de la nómina</label>
                                <input type="date" class="form-control" id="exampleInputName1 fechaNomina validationCustom01"
                                    placeholder="Día / Mes / Año" name="fechaNomina" required>
                            ...
                            <div class="form-group">
                                <label for="exampleInputName1 validationCustom01">Nombre de la novedad</label>
                                <input type="text" class="form-control" id="exampleInputName1 nombreNovedad validationCustom01"
                                    placeholder="Puede colocar el nombre de está nueva novedad." name="tipoNovedad" value="Vacaciones" readonly>
                                    <div class="invalid-feedback">
                                      La nombre no es valida.
                                    </div>
                                    <div class="valid-feedback">
                                      El nombre es valido!
                                    </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputName1 validationCustom01">Fecha de la novedad</label>
                                <input type="date" class="form-control" id="exampleInputName1 fechaNovedad validationCustom01"
                                    placeholder="Día / Mes / Año" name="fechaNovedad" required>
                                    <div class="invalid-feedback">
                                      La fecha no es valida.
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <input value="${nomina.getValorTotal()}" name="ValorTotal" type="hidden">
                            <input value="${nomina.getIdConcepto()}" name="idConcepto" type="hidden">


                            <div class="form-group">
                              <label for="exampleInputName1 validationCustom01">Nombre del empleado</label>
                              <input type="text" class="form-control" id="exampleInputName1 nombreNovedad validationCustom01"
                                  placeholder="Puede colocar el nombre de está nueva novedad." value="${nomina.getnombreEmpleado()}" disabled>
                                  <div class="invalid-feedback">
                                    La nombre no es valida.
                                  </div>
                                  <div class="valid-feedback">
                            ...
                            <div class="form-group">
                                <label for="exampleInputName1 validationCustom01">Salario Basico</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-primary text-white">$</span>
                                    </div>
                                    <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)" id="valorNovedad validationCustom01" value="${nomina.getSalarioBaseLista()}" name="SueldoBase" readonly>
                                    <div class="input-group-append">
                                        <span class="input-group-text">.00</span>
                                    </div>
                                    <div class="invalid-feedback">
                                      El valor no es valida.
                                    </div>
                                    <div class="valid-feedback">
                                      El valor es valido!
                                    </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputName1 validationCustom01">Días trabajados</label>
                                <input type="number" class="form-control" id="exampleInputName1 diasNovedad validationCustom01"
                                    placeholder="Coloque aquí los días trabajados" name="diasNovedad" required>
                                    <div class="invalid-feedback">
                                      Los días no es valida.
                                    </div>
                                    <div class="valid-feedback">
                                      Los días es valido!
                                    </div>
                            ...
                            <button type="submit" class="btn btn-primary mr-2" name="accion" value="addVacaciones">Enviar</button>
