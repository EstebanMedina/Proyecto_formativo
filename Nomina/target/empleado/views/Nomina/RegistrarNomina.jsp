            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body"><br><br><br>
                        <h4 class="card-title">Agregar una novedad(Horas extra)</h4>
                        <p class="card-description">Registra una novedad de horas extra</p>
                        ...
                        <form class="forms-sample needs-validation" action="nomina" method="post" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputName1 nombreNovedad validationCustom01"
                                    placeholder="Puede colocar el nombre de está nueva novedad." name="tipoNovedad" value="Horas extra" readonly>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                <label for="exampleInputName1 validationCustom01">Sueldo base</label>
                            ...
                            <div class="form-group">
                              <label for="exampleInputName1 validationCustom01">Horas extras</label>
                              <input type="text" class="form-control" id="exampleInputName1 tipoNovedad validationCustom01"
                                  placeholder="Puede colocar el Tipo de está nueva novedad." name="diasNovedad" required>
                                  <div class="invalid-feedback">
                                    Tipo de novedad no es valida.
                                  </div>
                                  <div class="valid-feedback">
                                    Tipo de novedad es valido!
                                  </div>
                          </div>
