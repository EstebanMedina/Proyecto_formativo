...
<html lang="en">
  <head>
    ...
    <title>Consulta de Nomina</title>
    <!-- plugins:css -->
...
if (OK) {
  $.ajax({
    url:"nomina?accion=editar&idNomina="+id,
  ...
  icon: "success",
          ...
          if(OK){
              location.href="nomina?accion=editar&idNomina="+id
          }
        });
} else {
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body"><br><br><br>
                                <h4 class="card-title">Tabla de Nominas</h4>
                                </p>
                                <div class="table-responsive">
                                    <table class="table table-bordered datatable" id="datatable">
                                        <thead>
                                            ...
                                            <th>Nombre Nov</th>
                                            <th>Valor Nov</th>
                                            <th>Tiempo (Horas extras/Dias Vacaciones)</th>
                                            <th> Acciones</th>
                                        </thead>
                                        <tbody>
                                            <c:forEach var="nomina" items="${nomina}">
                                                <tr>
                                                    <td>${nomina.getIdNomina()}</td>
                                                    <td>${nomina.getNombreNovedad()}</td>
                                                    <td>${nomina.getValorNovedad()}</td>
                                                    <td>${nomina.getTipoNovedad()}</td>
                                                    <td align="center">
                                                      <a onclick="Editar([[${nomina.getIdNomina()}]])">
