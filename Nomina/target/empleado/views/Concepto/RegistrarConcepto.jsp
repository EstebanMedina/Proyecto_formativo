      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body"><br><br><br>
            <h4 class="card-title">Agregar un concepto</h4>
            <p class="card-description">Registra todos los datos para poder agregar un nuevo concepto</p>
            <form class="forms-sample" action="concepto" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)" id="SalarioBase" name="SalarioBase">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputName1"
                      placeholder="Coloque aquí los días trabajados" id="DiasTrabajados" name="DiasTrabajados">
                  </div>

                  <div class="form-group">
                    <label for="exampleSelectGender">Empleado</label>
                    <select class="form-control" id="exampleSelectGender" name="idEmpleado">
                      <option value="" selected disabled hidden>Escoje uno aquí</option>
                      <c:forEach var="idEmpleado" items="${idEmpleado}">
                        <option value="${idEmpleado.getIdEmpleado()}">${idEmpleado.getNombreEmpleado()}</option>
                    </c:forEach>
                    </select>
                  </div>
