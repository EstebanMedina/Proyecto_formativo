      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="nomina?accion=abrir"><img src="assets/img/vsg/plus-square.svg" alt="">| Agregar una nómina</a></li>
      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body"><br><br><br>
            ...
            <p class="card-description">Registra todos los datos para poder agregar un empleado</p>
            <form class="forms-sample needs-validation" action="empleado" method="post" novalidate>
              <div class="form-group">
                <label for="exampleInputName1 validationCustom01">Nombre del empleado</label>
                <input type="text" class="form-control" id="nombreEmpleado validationCustom01 exampleInputName1"
                  placeholder="Ej: Andres Velez, Carlos Andres, Mauricio, etc..." name="nombreEmpleado" required>
              ...
              <div class="form-group">
                <label for="exampleInputName1 validationCustom01">Apellido del empleado</label>
                <input type="text" class="form-control" id="apellidoEmpleado exampleInputName1 validationCustom01"
                  placeholder="Ej: Aguilar Peréz, Acevedo Manriquez, López, etc..." name="apellidoEmpleado" required>
                  <div class="invalid-feedback">
                    El apellido no es valida.
                  </div>
                  <div class="valid-feedback">
                    El apellido es valida!
                  </div>
              </div>

              <div class="form-group">
                <label for="exampleSelectGender validationCustom01">Tipo de documento</label>
                <select class="form-control" id="exampleSelectGender tipoDocumento validationCustom01" name="tipoDocumento" required>
                  <option selected disabled> Seleccione uno aquí...</option>
              ...
              <div class="form-group">
                <label for="exampleInputName1 validationCustom01">Número de documento</label>
                <input type="number" class="form-control" id="exampleInputName1 documentoEmpleado validationCustom01" name="documentoEmpleado"
                  placeholder="Coloque aquí su número. Recuerde que el número de documento debe tener más de 10 dígitos (Ej: 1031803081)." required>
                  <div class="invalid-feedback">
                    El número no es valida.
                  </div>
                  <div class="valid-feedback">
                    El número es valida!
                  </div>
              ...
              <div class="form-group">
                <label for="exampleInputName1 validationCustom01">Número de teléfono</label>
                <input type="text" class="form-control" id="telefonoEmpleado exampleInputName1 validationCustom01"
                  placeholder="Coloque aquí su número de telefono" name="telefonoEmpleado" required>
                  <div class="invalid-feedback">
                  El número no es valida.
                </div>
                <div class="valid-feedback">
              ...
              <div class="form-group">
                <label for="exampleSelectGender ">Usuario</label>
                <select class="form-control" id="exampleSelectGender " name="idUsuario" required>
                  <option selected disabled> Seleccione uno aquí...</option>
                  <c:forEach var="idUsuario" items="${idUsuario}">
                    <option value="${idUsuario.getIdUsuario()}">${idUsuario.getUserName()}</option>
                  </c:forEach>
                </select>
              </div>
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="exampleSelectGender idCargo " name="idCargo" required>
                  <option value="" selected disabled hidden>Escoje uno aquí</option>
                  <c:forEach var="idCargo" items="${idCargo}">
                    <option value="${idCargo.getIdCargo()}">${idCargo.getNombreCargo()}</option>
                </c:forEach>
                </select>
              </div>

              <div class="form-group">
                <label for="exampleInputName1">Sueldo cargo</label>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text bg-primary text-white">$</span>
                    </div>
                    <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)" id="sueldoCargo" name="sueldoCargo">
                </div>
            </div>

              <div class="form-group">
                <label for="exampleSelectGender">Estado en la empresa</label>
                <select class="form-control" id="exampleSelectGender estadoEmpleado" name="estadoEmpleado">
                  <option value="" selected disabled hidden>Escoje uno aquí</option>
                  <option name="estadoEmpleado">Activo</option>
                  <option name="estadoEmpleado">Inactivo</option>
                </select>
              </div>
