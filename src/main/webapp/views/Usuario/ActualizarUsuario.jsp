      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="nomina?accion=listar"><img src="assets/img/vsg/clipboard.svg" alt="">| Consultar un novedad</a></li>
              </ul>
            </div>
          </li>
      ...
      <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body"><br><br><br>
            <h4 class="card-title">Editar un usuario</h4>
            <p class="card-description">Registra todos los datos para poder editar un usuario</p>
          <c:forEach var="usuarioA" items="${usuarioA}">
            <form class="forms-sample" action="usuario" method="post">
                <div class="form-group">
                    <label for="exampleInputName1">Nombre del usuario</label>
                    <input type="text" class="form-control" id="exampleInputName1 username" name="username"
                      placeholder="Ej: Andres Velez, Carlos Andres, Mauricio, etc..." value="${usuarioA.getUserName()}">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputName1">Contraseña</label>
                    <input type="password" class="form-control" id="exampleInputName1 pass" name="pass"
                    placeholder="Coloque aquí la contraseña del usuario" value="${usuarioA.getPass()}">
                  </div>
